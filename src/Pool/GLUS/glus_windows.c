...
static GLUSvoid (*glusMouseMove)(GLUSuint buttons, GLUSint xPos, GLUSint yPos) = NULL;
...
GLUSvoid GLUSAPIENTRY glusMouseMoveFunc( GLUSvoid (*glusNewMouseMove)(GLUSuint buttons, GLUSint xPos, GLUSint yPos) )
{
...
GLUSAPI GLUSvoid GLUSAPIENTRY glusPrintErrorMsg(GLenum errCode)
{
  switch(errCode)
  {
  case GL_NO_ERROR:
    fprintf(stderr, "GL_NO_ERROR: No error has been recorded.");
    break;
  ...
  case GL_INVALID_VALUE:
    fprintf(stderr, "GL_INVALID_VALUE: A numeric argument is out of range. \n");
    break;

  case GL_STACK_OVERFLOW:
    fprintf(stderr, "GL_STACK_OVERFLOW: This command would cause a stack overflow. \n");
    break;

  case GL_STACK_UNDERFLOW:
    fprintf(stderr, "GL_STACK_UNDERFLOW: This command would cause a stack underflow. \n");
    break;
  ...
  //  fprintf(stderr, "GL_TABLE_TOO_LARGE: The specified table exceeds the implementation's maximum supported table size. \n");
  //  break;

  default:
    fprintf(stderr, "Unexpected OpenGL error!");
    break;
